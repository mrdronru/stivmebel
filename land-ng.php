      ...
      <div class="l-utp-grid">
        <div class="l-utp-item">
          ...
          <div class="l-utp-body">
            ...
            <div class="l-utp-text">Итоговую сумму фиксируем в договоре после согласования проекта, и дальше она не меняется. Измениться она может только если вы сами вносите изменения в проект.</div>
          </div>
        </div>
        <div class="l-utp-item">
          <div class="l-utp-icon">
