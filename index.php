...
<section id="hero" style="padding: 0;">
  <div class="hero-left">
    ...
    <!--
      ВАРИАНТЫ ЗАГОЛОВКА HERO:
      1. Мебель, которую<br>не нужно<br><em>переделывать</em>
      2. Пространство,<br>в котором<br><em>всё на своём месте</em>
      3. Сделано один раз.<br><em>Сделано правильно.</em>
      4. Мебель, за которой<br>не нужно<br><em>следить</em>
      5. Ваш интерьер —<br>точно так,<br><em>как вы задумали</em>
      6. Корпусная мебель<br>без компромиссов<br>и <em>сюрпризов</em>
      7. Мебель, которая<br>живёт дольше,<br><em>чем вы ожидаете</em>
      8. Когда результат<br>важнее,<br><em>чем цена</em>
      9. Спроектируем.<br>Изготовим.<br><em>Сдадим без замечаний.</em>
      10. Ваш дом заслуживает<br>мебели,<br><em>сделанной под него</em>
    -->
