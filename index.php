...
$description = 'Проектируем и изготавливаем кухни, шкафы, гардеробные в Москве и МО. Бесплатный замер, 3D-проект и монтаж под ключ. Точность до 1 мм. Гарантия 2 года. С 2012 года.';
include 'header.php';
?>
...
<section id="advantages">
  ...
  <div class="adv-list reveal" style="transition-delay: 0.15s;">
    ...
    <div class="adv-item">
      ...
      <div class="adv-text">Выезд специалиста на замер и консультация — бесплатно.</div>
    </div>
    <div class="adv-item">
  ...
  <div class="pricing-text reveal">
    ...
    <div class="pricing-from">
      <div class="pricing-from-item">
        <span class="pricing-from-num"><?php echo price_from('wardrobes'); ?></span>
        <span class="pricing-from-label">за п.м. — шкафы</span>
      </div>
      <div class="pricing-from-item">
        <span class="pricing-from-num"><?php echo price_from('kitchens'); ?></span>
...
<section id="contact" style="padding: 0;">
  <div class="contact-left reveal">
    ...
    <div class="contact-detail">
      ...
      <a href="<?php echo SOCIAL_VK_PAGE; ?>" class="contact-line" target="_blank" rel="noopener" onclick="ymGoal('click_vk')">
        <div class="contact-line-icon">
