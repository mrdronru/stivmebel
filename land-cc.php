...
$page           = '';
$title          = 'Мебель на заказ в ЖК Сердце Столицы';
      ...
      <div class="l-utp-grid">
        ...
        <div class="l-utp-item">
          ...
          <div class="l-utp-body">
            ...
            <div class="l-utp-text">Итоговую сумму фиксируем в договоре после согласования проекта, и дальше она не меняется. Изменить её может только изменение проекта по вашей просьбе.</div>
          </div>
        </div>
      </div>
    </div>
